...
Run the database verification from the Aerial devel container after `pyaerial_setup`:

	docker exec -it c_aerial_$USER bash -c "source pyaerial/.venv/bin/activate && ./cuPHY-CP/data_lake/tests/compare_db_to_lp.py launch_pattern_DATALAKE_4C.yaml"
