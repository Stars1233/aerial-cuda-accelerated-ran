...
#include "nvlog.hpp"
// Same numeric tag as legacy NVLOG_TAG_BASE_CUPHY_DRIVER + 42 (242); base is UTIL for gt_common_libs
#define PMU_TAG (NVLOG_TAG_BASE_UTIL + 162)
...
struct CacheMissRatioMetrics final {
