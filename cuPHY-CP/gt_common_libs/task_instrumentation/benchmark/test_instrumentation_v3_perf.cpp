...
void print_comparison_table(const perf_metrics::PercentileTracker::Statistics& baseline,
    ...
    // DISABLED mode
    double mode0_oh_mean = ((static_cast<double>(mode0.mean) / static_cast<double>(baseline.mean)) - 1.0) * 100.0;
    double mode0_oh_p999 = ((static_cast<double>(mode0.p999) / static_cast<double>(baseline.p999)) - 1.0) * 100.0;
    ...
    double mode1_oh_mean = ((static_cast<double>(mode1.mean) / static_cast<double>(baseline.mean)) - 1.0) * 100.0;
    double mode1_oh_p999 = ((static_cast<double>(mode1.p999) / static_cast<double>(baseline.p999)) - 1.0) * 100.0;
    ...
    // START_END_ONLY mode
    double mode2_oh_mean = ((static_cast<double>(mode2.mean) / static_cast<double>(baseline.mean)) - 1.0) * 100.0;
    double mode2_oh_p999 = ((static_cast<double>(mode2.p999) / static_cast<double>(baseline.p999)) - 1.0) * 100.0;
    ...
    double ctor_oh_mean = ((static_cast<double>(ctor_dtor.mean) / static_cast<double>(baseline.mean)) - 1.0) * 100.0;
    double ctor_oh_p999 = ((static_cast<double>(ctor_dtor.p999) / static_cast<double>(baseline.p999)) - 1.0) * 100.0;
