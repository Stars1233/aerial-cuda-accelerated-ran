...
#include "task_instrumentation/task_instrumentation_nested.hpp"  // For ti_subtask_info
#include <cstdint>
#include <cstring>
 ...
 */
struct TaskInstrumentationContext final {
 ...
 */
class TaskInstrumentation final {
public:
    /**
     ...
     */
    void append(const char* subtask_name, perf_metrics::t_ns time) noexcept;
...
private:
     ...
     */
    [[nodiscard]] bool formatSubtask(const char* subtask_name, uint64_t timestamp_ns) noexcept;
};
