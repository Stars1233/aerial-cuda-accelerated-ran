...
private:
    ...
    uint32_t m_freqTxDataSizeDl{}, m_freqTxDataSizeUl{}; // length of frequency-domain tx sample
    uint32_t m_timeTxDataSizeDl{}, m_timeTxDataSizeUl{}; // length of time-domain tx sample
    uint32_t m_freqRxDataSizeDl{}, m_freqRxDataSizeUl{}; // length of frequency-domain rx sample, for adding noise
