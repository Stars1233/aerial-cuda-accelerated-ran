...
**Typical Executable Path**: `./build.aarch64/testBenches/gpu3GPPChan/examples/sls_chan/sls_chan_ex`
...
cd $cuBB_SDK/testBenches/gpu3GPPChan/util
...
**Phase 1 Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_phase1.yaml`

**Phase 2 Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_phase2.yaml`

**Reference Data**: `testBenches/gpu3GPPChan/util/3gpp_calibration_phase1.json` (Phase 1) and `testBenches/gpu3GPPChan/util/3gpp_calibration_phase2.json` (Phase 2)
...
**Note**: All calibration scripts are located in `testBenches/gpu3GPPChan/util/` and can be run from the util directory.
...
**YAML Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_phase1.yaml`
...
**YAML Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_phase2.yaml`
...
**Reference**: `testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase1.json`

#### Phase 1 Target Channel

**YAML Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1.yaml`
...
**YAML Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1_background.yaml` The difference from target channel calibration is the `isac_disable_background` and `isac_disable_target` to only include background channel.
...
**Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase2.yaml`

**Reference**: `testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase2.json`
...
**Config**: `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase2_background.yaml`. The difference from target channel calibration is the `isac_disable_background` and `isac_disable_target` to only include background channel.
...
**Command**:
```bash
./build.aarch64/testBenches/gpu3GPPChan/examples/sls_chan/sls_chan_ex <config.yaml>
```
...
```bash
python3 testBenches/gpu3GPPChan/util/analysis_channel_stats.py \
    slsChanData_*.h5 \
    --reference-json <REFERENCE_JSON> \
...
### Configuration Files
- `testBenches/gpu3GPPChan/config/statistic_channel_config_phase1.yaml` - UMa calibration
- `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1.yaml` - ISAC Phase 1 target
- `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1_background.yaml` - ISAC Phase 1 background
- `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase2.yaml` - ISAC Phase 2 target
- `testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase2_background.yaml` - ISAC Phase 2 background

### Reference Data (3GPP)
- `testBenches/gpu3GPPChan/util/3gpp_calibration_uma_6ghz.json` - UMa reference
- `testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase1.json` - ISAC Phase 1 reference
- `testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase2.json` - ISAC Phase 2 reference
