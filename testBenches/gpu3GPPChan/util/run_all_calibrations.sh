...
if [ "$RUN_UMA" = true ]; then
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        ...
        --config testBenches/gpu3GPPChan/config/statistic_channel_config_phase1.yaml \
        --dataset uma_6ghz \
        --reference-json testBenches/gpu3GPPChan/util/3gpp_calibration_phase1.json \
        --phase 1 \
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        --seed-start $UMA_SEED_START \
        --seed-end $UMA_SEED_END \
        --config testBenches/gpu3GPPChan/config/statistic_channel_config_phase2.yaml \
        --dataset uma_6ghz \
        --reference-json testBenches/gpu3GPPChan/util/3gpp_calibration_phase2.json \
        --phase 2 \
...
if [ "$RUN_ISAC" = true ]; then
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        ...
        --config testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1.yaml \
        --dataset isac_uav_phase1_target \
        --reference-json testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase1.json \
        --phase 1 \
        --isac-channel target \
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        --seed-start $ISAC_SEED_START \
        --seed-end $ISAC_SEED_END \
        --config testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase1_background.yaml \
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        ...
        --reference-json testBenches/gpu3GPPChan/util/3gpp_calibration_isac_uav_phase2.json \
        --phase 2 \
        --isac-channel target \
    ...
    "$SCRIPT_DIR/run_sls_chan_multiseed.sh" \
        --seed-start $ISAC_SEED_START \
        --seed-end $ISAC_SEED_END \
        --config testBenches/gpu3GPPChan/config/statistic_channel_config_isac_phase2_background.yaml \
