...
#if !defined(LDPC2_REG_BOX_PLUS_SPEC_HIGH_HPP_INCLUDED_)
#define LDPC2_REG_BOX_PLUS_SPEC_HIGH_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_spec_high
// Z-specialized decoder kernel that only works for high to medium code
// rates. (Another kernel must be chosen for low code rates.) For the
// specific threshold, see the implementation file.)
class reg_box_plus_spec_high : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_box_plus_spec_high(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_BOX_PLUS_SPEC_HIGH_HPP_INCLUDED_)
