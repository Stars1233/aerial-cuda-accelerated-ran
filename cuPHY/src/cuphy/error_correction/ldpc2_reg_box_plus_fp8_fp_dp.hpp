...
#if !defined(LDPC2_REG_BOX_PLUS_FP8_FP_DP_HPP_INCLUDED_)
#define LDPC2_REG_BOX_PLUS_FP8_FP_DP_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp_dp
class reg_box_plus_fp8_fp_dp : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_box_plus_fp8_fp_dp(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_BOX_PLUS_FP8_FP_DP_HPP_INCLUDED_)
