...
#if !defined(LDPC2_ALGO203_HPP_INCLUDED_)
#define LDPC2_ALGO203_HPP_INCLUDED_
...
class bg1_z256up_bp_shwin_x2 : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    explicit bg1_z256up_bp_shwin_x2(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_ALGO203_HPP_INCLUDED_)
