...
#if !defined(LDPC2_INDEX_FP_X2_ALLREG_REGAPP_HPP_INCLUDED_)
#define LDPC2_INDEX_FP_X2_ALLREG_REGAPP_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// index_fp_x2_allreg_regapp
// Register-APP x2 variant (ALGO 52): stores overflow extension column
// APP values in registers to bypass GB203 shmem limits at BG1 p=44-46.
// All C2V in registers (like ALGO 51), shmem capped at 65 columns.
class index_fp_x2_allreg_regapp : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    index_fp_x2_allreg_regapp(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_INDEX_FP_X2_ALLREG_REGAPP_HPP_INCLUDED_)
