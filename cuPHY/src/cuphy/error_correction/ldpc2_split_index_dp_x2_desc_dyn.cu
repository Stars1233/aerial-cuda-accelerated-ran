...
namespace
{
    ...
    struct ldpc2_split_index_dp_x2_desc_dyn_kernel_config
    {
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_split_index_dp_x2_desc_dyn()
// Kernel for base graph 1 (legacy tensor interface)
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_split_index_dp_x2_desc_dyn(LDPC_kernel_params params, app_loc_t<1>::bg_desc_t bgdesc)
{
    ...
    typedef ldpc2_split_index_dp_x2_desc_dyn_kernel_config<1,                                          // BG
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_split_index_dp_x2_desc_dyn()
// Kernel for base graph 1 (legacy tensor interface)
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_split_index_dp_x2_desc_dyn(LDPC_kernel_params params, app_loc_t<2>::bg_desc_t bgdesc)
{
    // Shared memory is allocated dynamically
    extern __shared__ char smem[];
    ...
    //------------------------------------------------------------------
    // Kernel configuration template
    typedef ldpc2_split_index_dp_x2_desc_dyn_kernel_config<2,                                          // BG
                                                           ldpc2::LDPC_kernel_params> kernel_config_t; // params struct
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_split_index_dp_x2_desc_dyn_tb()
// Kernel for base graph 1 (transport block interface)
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_split_index_dp_x2_desc_dyn_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
...
#endif
    ldpc_et_context_x2_t* et_ctx = ldpc2::get_et_ctx_ptr<ldpc_et_context_x2_t>(smem, static_cast<uint32_t>(size_before_et));
    ldpc2::early_term_initialize_if_enabled<ENABLE_ACCESSORY_FEATURES, ldpc2::et_crc_traits<kernel_config_t::app_buf_t>::cw_per_cta>(
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_split_index_dp_x2_desc_dyn_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_split_index_dp_x2_desc_dyn_tb()
// Kernel for base graph 2 (transport block interface)
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_split_index_dp_x2_desc_dyn_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
    // Shared memory is allocated dynamically
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_split_index_dp_x2_desc_dyn_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
    // Shared memory is allocated dynamically
...
////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::decode()
cuphyStatus_t split_index_dp_x2_desc_dyn::decode(ldpc::decoder&                     dec,
                                                 LDPC_output_t&                     tDst,
                                                 ...
                                                 cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc::decode_ldpc2_split_index_dp_x2_desc_dyn()\n");
    //------------------------------------------------------------------
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_split_index_dp_x2_desc_dyn, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                ldpc2_BG1_split_index_dp_x2_desc_dyn<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_split_index_dp_x2_desc_dyn, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                ldpc2_BG2_split_index_dp_x2_desc_dyn<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        default:
...
////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::decode_tb()
cuphyStatus_t split_index_dp_x2_desc_dyn::decode_tb(ldpc::decoder&               dec,
                                                    const cuphyLDPCDecodeDesc_t& decodeDesc,
                                                    cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::split_index_dp_x2_desc_dyn::decode_tb()\n");
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_split_index_dp_x2_desc_dyn_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
               LDPC_LAUNCH_TB_KERNEL_X2(ldpc2_BG1_split_index_dp_x2_desc_dyn_tb, decodeDesc.config.flags,
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_split_index_dp_x2_desc_dyn_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL_X2(ldpc2_BG2_split_index_dp_x2_desc_dyn_tb, decodeDesc.config.flags,
                    grdDim, blkDim, SHMEM_SIZE, strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
...
////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::get_workspace_size()
std::pair<bool, size_t> split_index_dp_x2_desc_dyn::get_workspace_size(const ldpc::decoder&               dec,
                                                                       const cuphyLDPCDecodeConfigDesc_t& config,
                                                                       int                                num_cw)
{
...
////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::split_index_dp_x2_desc_dyn()
split_index_dp_x2_desc_dyn::split_index_dp_x2_desc_dyn(ldpc::decoder& dec)
{
    //------------------------------------------------------------------
    ...
    const int MAX_BG2_SHMEM_SIZE = get_shmem_required(2,                             // BG
    ...
    {
        func_attr_t((const void*)ldpc2_BG1_split_index_dp_x2_desc_dyn,    std::min(MAX_BG1_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t((const void*)ldpc2_BG2_split_index_dp_x2_desc_dyn,    std::min(MAX_BG2_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t((const void*)ldpc2_BG1_split_index_dp_x2_desc_dyn_tb, std::min(MAX_BG1_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t((const void*)ldpc2_BG1_split_index_dp_x2_desc_dyn_tb_no_accessories, std::min(MAX_BG1_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t((const void*)ldpc2_BG2_split_index_dp_x2_desc_dyn_tb, std::min(MAX_BG2_SHMEM_SIZE, MAX_SHMEM)),
        func_attr_t((const void*)ldpc2_BG2_split_index_dp_x2_desc_dyn_tb_no_accessories, std::min(MAX_BG2_SHMEM_SIZE, MAX_SHMEM))
    };
    ...
    //------------------------------------------------------------------
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_split_index_dp_x2_desc_dyn);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_split_index_dp_x2_desc_dyn);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_split_index_dp_x2_desc_dyn_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_split_index_dp_x2_desc_dyn_tb);
}

////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::can_decode_config()
bool split_index_dp_x2_desc_dyn::can_decode_config(const ldpc::decoder&               dec,
...
////////////////////////////////////////////////////////////////////////
// split_index_dp_x2_desc_dyn::get_launch_config()
cuphyStatus_t split_index_dp_x2_desc_dyn::get_launch_config(const ldpc::decoder&           dec,
                                                            cuphyLDPCDecodeLaunchConfig_t& launchConfig)
{
    ...
    cudaError_t    e = (BG == 1) ? LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG1_split_index_dp_x2_desc_dyn_tb, launchConfig.decode_desc.config.flags) :
                                   LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG2_split_index_dp_x2_desc_dyn_tb, launchConfig.decode_desc.config.flags);
    if (e != cudaSuccess)
    {
