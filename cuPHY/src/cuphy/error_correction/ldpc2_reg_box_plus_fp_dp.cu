...
namespace
{
    ...
    // Using floating point instruction with dot product APP address
    ...
    template <int   BG_,
              ...
              int   MAX_PARITY_ROWS,
              class TKernelParams>
    struct ldpc2_reg_box_plus_fp_dp_kernel_config
    {
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp_dp()
// Base graph 1 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp_dp(LDPC_kernel_params params, app_loc_t<1>::bg_desc_t bgdesc)
{
    ...
    typedef ldpc2_reg_box_plus_fp_dp_kernel_config<1,
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp_dp()
// Base graph 2 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp_dp(LDPC_kernel_params params, app_loc_t<2>::bg_desc_t bgdesc)
{
    // Shared memory is allocated dynamically
    extern __shared__ char smem[];
    ...
    //------------------------------------------------------------------
    // Kernel configuration template
    typedef ldpc2_reg_box_plus_fp_dp_kernel_config<2, // BG
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp_dp_tb_impl<ENABLE_ACCESSORY_FEATURES, DUMP>()
...
void ldpc2_BG1_reg_box_plus_fp_dp_tb_impl(const cuphyLDPCDecodeDesc_t& decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp_dp_tb_impl<ENABLE_ACCESSORY_FEATURES, DUMP>()
// Base graph 2 body, shared by _tb, _tb_no_accessories and _tb_dumpApp.
// DUMP adds the ET-free per-iteration APP dump; discarded when false.
template <bool ENABLE_ACCESSORY_FEATURES, bool DUMP>
__device__ __forceinline__
void ldpc2_BG2_reg_box_plus_fp_dp_tb_impl(const cuphyLDPCDecodeDesc_t& decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    // smem_tb, not smem: a template's extern __shared__ clashes (nvcc #1556)
    // with the non-template kernels in this file.
    extern __shared__ char smem_tb[];

    typedef ldpc2_reg_box_plus_fp_dp_kernel_config<2,
                  NUM_STORAGE_WORDS_BG2,
                  MAX_NUM_PARITY_BG2,
                  cuphyLDPCDecodeConfigDesc_t> kernel_config_t;
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp_dp_tb()
// Base graph 1 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp_dp_tb(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
    ldpc2_BG1_reg_box_plus_fp_dp_tb_impl<true, false>(decodeDesc, bgdesc);
}

extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp_dp_tb_no_accessories(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
    ldpc2_BG1_reg_box_plus_fp_dp_tb_impl<false, false>(decodeDesc, bgdesc);
}

////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp_dp_tb()
// Base graph 2 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp_dp_tb(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    ldpc2_BG2_reg_box_plus_fp_dp_tb_impl<true, false>(decodeDesc, bgdesc);
}

extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp_dp_tb_no_accessories(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    ldpc2_BG2_reg_box_plus_fp_dp_tb_impl<false, false>(decodeDesc, bgdesc);
}
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp_dp_tb_dumpApp(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1>::bg_desc_t bgdesc)
{
    ldpc2_BG1_reg_box_plus_fp_dp_tb_impl<false, true>(decodeDesc, bgdesc);
}
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp_dp_tb_dumpApp(const __grid_constant__ cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2>::bg_desc_t bgdesc)
{
    ldpc2_BG2_reg_box_plus_fp_dp_tb_impl<false, true>(decodeDesc, bgdesc);
}
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp::decode()
cuphyStatus_t reg_box_plus_fp_dp::decode(ldpc::decoder&                     dec,
                                         LDPC_output_t&                     tDst,
                                         ...
                                         cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc2::reg_box_plus_fp_dp::decode()\n");
    //------------------------------------------------------------------
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp_dp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG1_reg_box_plus_fp_dp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp_dp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG2_reg_box_plus_fp_dp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        default:
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp::decode_tb()
cuphyStatus_t reg_box_plus_fp_dp::decode_tb(ldpc::decoder&               dec,
                                            const cuphyLDPCDecodeDesc_t& decodeDesc,
                                            cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::reg_box_plus_fp_dp::decode_tb()\n");
    cuphyStatus_t s = CUPHY_STATUS_NOT_SUPPORTED;
    //------------------------------------------------------------------
        ...
        case 1:
            {
                ...
                if(0 != (decodeDesc.config.flags & CUPHY_LDPC_DECODE_DUMP_INTERM))
                {
                    ...
                    DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp_dp_tb_dumpApp, blkDim, SHMEM_SIZE);
                    ldpc2_BG1_reg_box_plus_fp_dp_tb_dumpApp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(decodeDesc, *bgdesc);
                }
                else
#endif
                {
                    DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp_dp_tb, blkDim, SHMEM_SIZE);
                    LDPC_LAUNCH_TB_KERNEL(ldpc2_BG1_reg_box_plus_fp_dp_tb, decodeDesc.config.flags,
        ...
        case 2:
            {
                ...
                {
                    // Dump requested: launch the ET-free dump twin.
                    DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp_dp_tb_dumpApp, blkDim, SHMEM_SIZE);
                    ldpc2_BG2_reg_box_plus_fp_dp_tb_dumpApp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(decodeDesc, *bgdesc);
                }
                else
#endif
                {
                    DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp_dp_tb, blkDim, SHMEM_SIZE);
                    LDPC_LAUNCH_TB_KERNEL(ldpc2_BG2_reg_box_plus_fp_dp_tb, decodeDesc.config.flags,
                        grdDim, blkDim, SHMEM_SIZE, strm, decodeDesc, *bgdesc);
                }
                s = CUPHY_STATUS_SUCCESS;
            }
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp::get_workspace_size()
std::pair<bool, size_t> reg_box_plus_fp_dp::get_workspace_size(const ldpc::decoder&               dec,
                                                               const cuphyLDPCDecodeConfigDesc_t& config,
                                                               int                                num_cw)
{
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp::reg_box_plus_fp_dp()
reg_box_plus_fp_dp::reg_box_plus_fp_dp(ldpc::decoder& desc)
{
    ...
    {
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp_dp,    MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp_dp,    MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp_dp_tb, MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp_dp_tb_no_accessories, MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp_dp_tb, MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp_dp_tb_no_accessories, MAX_BG2_SHMEM_SIZE)
#if CUPHY_LDPC_SPLIT_DUMP_KERNELS
       ,func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp_dp_tb_dumpApp, MAX_BG1_SHMEM_SIZE)
       ,func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp_dp_tb_dumpApp, MAX_BG2_SHMEM_SIZE)
#endif
    };
    ...
    //------------------------------------------------------------------
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp_dp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp_dp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp_dp_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp_dp_tb);
}

////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp::get_launch_config()
cuphyStatus_t reg_box_plus_fp_dp::get_launch_config(const ldpc::decoder&           dec,
                                                    cuphyLDPCDecodeLaunchConfig_t& launchConfig)
{
    ...
    cudaError_t    e = (BG == 1) ?  LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG1_reg_box_plus_fp_dp_tb, launchConfig.decode_desc.config.flags):
                                    LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG2_reg_box_plus_fp_dp_tb, launchConfig.decode_desc.config.flags);
#if CUPHY_LDPC_SPLIT_DUMP_KERNELS
    ...
    {
        e = (BG == 1) ? cudaGetFuncBySymbol(&deviceFunction, (void*)ldpc2_BG1_reg_box_plus_fp_dp_tb_dumpApp)
                      : cudaGetFuncBySymbol(&deviceFunction, (void*)ldpc2_BG2_reg_box_plus_fp_dp_tb_dumpApp);
    }
#endif
    if (e != cudaSuccess)
    {
