...
#if !defined(LDPC2_REG_BOX_PLUS_FP8_FP_HPP_INCLUDED_)
#define LDPC2_REG_BOX_PLUS_FP8_FP_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp
class reg_box_plus_fp8_fp : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_box_plus_fp8_fp(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_BOX_PLUS_FP8_FP_HPP_INCLUDED_)
