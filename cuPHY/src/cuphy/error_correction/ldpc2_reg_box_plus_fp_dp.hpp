...
#if !defined(LDPC2_REG_BOX_PLUS_FP_DP_HPP_INCLUDED_)
#define LDPC2_REG_BOX_PLUS_FP_DP_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp_dp
// Box plus kernel that uses fp16 (floating point) instructions as well
// as the dot product instruction for APP address calculation.
class reg_box_plus_fp_dp : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    reg_box_plus_fp_dp(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_REG_BOX_PLUS_FP_DP_HPP_INCLUDED_)
