...
namespace
{
    ...
    // sequence
    template <int BG, class TFP8> using app_loc_t = app_loc_address_fp_desc<TFP8, BG>;
    ...
    template <int   BG_,
              ...
              class TFP8,
              class TLLRLoader>
    struct ldpc2_reg_box_plus_fp8_fp_kernel_config
    {
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp8_e4m3_fp()
// Base graph 1 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp(LDPC_kernel_params params, app_loc_t<1, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    ...
    using kernel_config_t = ldpc2_reg_box_plus_fp8_fp_kernel_config<1,
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp8_e4m3_fp()
// Base graph 2 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp(LDPC_kernel_params params, app_loc_t<2, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
#if __CUDA_ARCH__ >= 900
    // Shared memory is allocated dynamically
    extern __shared__ char smem[];
    ...
    using app_buf_t       = fp8_t;
    using llr_loader_t    = ldpc2::llr_loader_variable_batch<fp8_t, 4, llr_op_clamp>;
    using kernel_config_t = ldpc2_reg_box_plus_fp8_fp_kernel_config<2,
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb()
// Base graph 1 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb()
// Base graph 2 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp8_e5m2_fp()
// Base graph 1 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e5m2_fp(LDPC_kernel_params params, app_loc_t<1, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
#if __CUDA_ARCH__ >= 900
    // Shared memory is allocated dynamically
    extern __shared__ char smem[];
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp8_e5m2_fp()
// Base graph 2 kernel, "legacy" tensor interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e5m2_fp(LDPC_kernel_params params, app_loc_t<2, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
#if __CUDA_ARCH__ >= 900
    // Shared memory is allocated dynamically
    extern __shared__ char smem[];
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb()
// Base graph 1 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<1, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb()
// Base graph 2 kernel, transport block interface
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb_no_accessories(cuphyLDPCDecodeDesc_t decodeDesc, app_loc_t<2, __nv_fp8_e5m2>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
#if __CUDA_ARCH__ >= 900
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16()
// Base graph 1 kernel, "legacy" tensor interface, with conversion from
// fp16 to fp8 on input.
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16(LDPC_kernel_params                     params,
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16(LDPC_kernel_params                     params,
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb(cuphyLDPCDecodeDesc_t                  decodeDesc,
                                                app_loc_t<1, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb_no_accessories(cuphyLDPCDecodeDesc_t                  decodeDesc,
                                                app_loc_t<1, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
...
////////////////////////////////////////////////////////////////////////
// ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb()
// Base graph 2 kernel, transport block interface, with conversion from
// fp16 to fp8 on input.
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb(cuphyLDPCDecodeDesc_t                  decodeDesc,
                                                app_loc_t<2, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = true;
    extern __shared__ char smem[];
...
extern "C"
__global__ __launch_bounds__(MAX_THREADS_PER_CTA, MIN_CTA_PER_SM)
void ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb_no_accessories(cuphyLDPCDecodeDesc_t                  decodeDesc,
                                                app_loc_t<2, __nv_fp8_e4m3>::bg_desc_t bgdesc)
{
    [[maybe_unused]] constexpr bool ENABLE_ACCESSORY_FEATURES = false;
    extern __shared__ char smem[];
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp::decode()
cuphyStatus_t reg_box_plus_fp8_fp::decode(ldpc::decoder&                     dec,
                                          LDPC_output_t&                     tDst,
                                          ...
                                          cudaStream_t                       strm)
{
    DEBUG_PRINTF("ldpc2::reg_box_plus_fp8_fp::decode()\n");
    //------------------------------------------------------------------
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG1_reg_box_plus_fp8_e4m3_fp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG2_reg_box_plus_fp8_e4m3_fp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        default:
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e5m2_fp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG1_reg_box_plus_fp8_e5m2_fp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e5m2_fp, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG2_reg_box_plus_fp8_e5m2_fp<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        default:
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16, blkDim, SHMEM_SIZE);

                //-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
                // Launch the kernel
                ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16<<<grdDim, blkDim, SHMEM_SIZE, strm>>>(params, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        default:
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp::decode_tb()
cuphyStatus_t reg_box_plus_fp8_fp::decode_tb(ldpc::decoder&               dec,
                                             const cuphyLDPCDecodeDesc_t& decodeDesc,
                                             cudaStream_t                 strm)
{
    DEBUG_PRINTF("ldpc2::reg_box_plus_fp8_fp::decode_tb()\n");
    cuphyStatus_t s = CUPHY_STATUS_NOT_SUPPORTED;
    //------------------------------------------------------------------
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb, decodeDesc.config.flags,
        ...
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb, decodeDesc.config.flags,
                    grdDim, blkDim, shmem_size_with_et_context(SHMEM_SIZE), strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb, decodeDesc.config.flags,
                    grdDim, blkDim, shmem_size_with_et_context(SHMEM_SIZE), strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb, decodeDesc.config.flags,
                    grdDim, blkDim, shmem_size_with_et_context(SHMEM_SIZE), strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        ...
        case 1:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb, decodeDesc.config.flags,
                    grdDim, blkDim, shmem_size_with_et_context(SHMEM_SIZE), strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
        case 2:
            {
                ...
                DEBUG_PRINT_FUNC_MAX_BLOCKS(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb, blkDim, SHMEM_SIZE);

                //------------------------------------------------------------------
                // Launch the kernel
                LDPC_LAUNCH_TB_KERNEL(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb, decodeDesc.config.flags,
                    grdDim, blkDim, shmem_size_with_et_context(SHMEM_SIZE), strm, decodeDesc, *bgdesc);
                s = CUPHY_STATUS_SUCCESS;
            }
            break;
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp::get_workspace_size()
std::pair<bool, size_t> reg_box_plus_fp8_fp::get_workspace_size(const ldpc::decoder&               dec,
                                                                const cuphyLDPCDecodeConfigDesc_t& config,
                                                                int                                num_cw)
{
...
////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp::reg_box_plus_fp8_fp()
reg_box_plus_fp8_fp::reg_box_plus_fp8_fp(ldpc::decoder& desc)
{
    ...
    {
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp,         MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp,         MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb,      MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb_no_accessories,      MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb,      MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb_no_accessories,      MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e5m2_fp,         MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e5m2_fp,         MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb,      MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb_no_accessories,      MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb,      MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb_no_accessories,      MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16,    MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16,    MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb, MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb_no_accessories, MAX_BG1_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb, MAX_BG2_SHMEM_SIZE),
        func_attr_t((const void*)ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb_no_accessories, MAX_BG2_SHMEM_SIZE)
    };
    ...
    //------------------------------------------------------------------
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e5m2_fp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e5m2_fp);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb);
    DEBUG_PRINT_FUNC_ATTRIBUTES(ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb);
}

////////////////////////////////////////////////////////////////////////
// reg_box_plus_fp8_fp::get_launch_config()
cuphyStatus_t reg_box_plus_fp8_fp::get_launch_config(const ldpc::decoder&           dec,
                                                     cuphyLDPCDecodeLaunchConfig_t& launchConfig)
{
    ...
    if(BG == 1)
    {
        ...
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_tb, launchConfig.decode_desc.config.flags);
        }
        else if(llr_type == CUPHY_R_8F_E5M2)
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG1_reg_box_plus_fp8_e5m2_fp_tb, launchConfig.decode_desc.config.flags);
        }
        else if(llr_type == CUPHY_R_16F)
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG1_reg_box_plus_fp8_e4m3_fp_fp16_tb, launchConfig.decode_desc.config.flags);
        }
        else
        {
    ...
    else
    {
        if(llr_type == CUPHY_R_8F_E4M3)
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_tb, launchConfig.decode_desc.config.flags);
        }
        else if(llr_type == CUPHY_R_8F_E5M2)
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG2_reg_box_plus_fp8_e5m2_fp_tb, launchConfig.decode_desc.config.flags);
        }
        else if(llr_type == CUPHY_R_16F)
        {
            e = LDPC_GET_TB_KERNEL_FUNCTION(deviceFunction, ldpc2_BG2_reg_box_plus_fp8_e4m3_fp_fp16_tb, launchConfig.decode_desc.config.flags);
        }
        else
        {
            return CUPHY_STATUS_INVALID_ARGUMENT;
