...
#if !defined(LDPC2_SPLIT_INDEX_FP_DP_X2_DESC_DYN_HPP_INCLUDED_)
#define LDPC2_SPLIT_INDEX_FP_DP_X2_DESC_DYN_HPP_INCLUDED_
...
////////////////////////////////////////////////////////////////////////
// split_index_fp_dp_x2_desc_dyn
class split_index_fp_dp_x2_desc_dyn : public ldpc::decode_algo
{
public:
    //------------------------------------------------------------------
    // Constructor
    split_index_fp_dp_x2_desc_dyn(ldpc::decoder& desc);
    //------------------------------------------------------------------
    // decode()
...
#endif // !defined(LDPC2_SPLIT_INDEX_FP_DP_X2_DESC_DYN_HPP_INCLUDED_)
